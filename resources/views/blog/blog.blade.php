            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">@lang('content.title.7')</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="leave-comment-area mt-70 clearfix">
                        <div class="comment-form">
                            <h5>@lang('content.blog.reply_form.0')</h5>

                            <!-- Comment Form -->
                            <form action="#" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-name" placeholder="@lang('content.blog.reply_form.1')">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" id="contact-email" placeholder="@lang('content.blog.reply_form.2')">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" name="message" id="message" cols="30" rows="10" placeholder="@lang('content.blog.reply_form.3')"></textarea>
                                </div>
                                <button type="submit" class="btn south-btn">@lang('content.blog.reply_form.4')</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="blog-sidebar-area">
                        ...
                        <div class="search-widget-area mb-70">
                            <form action="#" method="get">
                                <input type="search" name="search" id="search" placeholder="@lang('content.blogs.other.0')">
                        ...
                        <div class="south-catagories-card mb-70">
                            <h5>@lang('content.blogs.archive.0')</h5>
                            <ul class="catagories-menu">
                                <li><a href="#">@lang('content.blogs.categories.1')</a></li>
                                <li><a href="#">@lang('content.blogs.categories.2')</a></li>
                                <li><a href="#">@lang('content.blogs.categories.3')</a></li>
                            </ul>
                        </div>

                        <!-- Catagories Widget -->
                        <div class="south-catagories-card mb-70">
                            <h5>@lang('content.blogs.categories.0')</h5>
                            <ul class="catagories-menu">
                                <li><a href="#">@lang('content.blogs.categories.1')</a></li>
                                <li><a href="#">@lang('content.blogs.categories.2')</a></li>
                                <li><a href="#">@lang('content.blogs.categories.3')</a></li>
